  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="bureaucratic-panel overflow-hidden rounded-dossier border border-steel/20 bg-white/84 shadow-docket">
        <div className="border-b border-steel/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.75),rgba(246,243,236,0.9))] px-8 py-8 sm:px-10 lg:px-12">
        ...
        <div className="space-y-8 px-8 py-8 sm:px-10 lg:px-12 lg:py-10">{children}</div>
      </div>
    </section>
  );
}
