...
export function PageShell({ title, intro, children }: PageShellProps) {
  return (
    <section className="mx-auto max-w-5xl px-3 py-10 sm:px-6 lg:px-8 lg:py-16">
      <div className="bureaucratic-panel overflow-hidden rounded-dossier border border-steel/20 bg-white/84 shadow-docket">
        <div className="border-b border-steel/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.75),rgba(246,243,236,0.9))] px-5 py-7 sm:px-8 sm:py-8 lg:px-12">
          <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-steel">{intro}</p>
            </div>
            <div className="rounded-[1.4rem] border border-steel/15 bg-paper/90 p-5">
