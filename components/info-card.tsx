...
export function InfoCard({ eyebrow, title, body }: InfoCardProps) {
  return (
    <article className="bureaucratic-panel rounded-dossier border border-steel/20 bg-white/80 p-6 shadow-sm">
      <p className="text-xs uppercase tracking-[0.28em] text-ink/72">{eyebrow}</p>
